...
MY_QUESTION = "Обьясни как делают сосиски как для ребёнка"
...
SYSTEM_PROMPT = "Ты грустный ИИ, описвай всё пессимистично и плачь"
...
def ask_llm(question: str) -> tuple:
    ...
    # --- конец блока ---
        ...
        print ("Oi yoi, Gigachat is dead, oi yoi")
